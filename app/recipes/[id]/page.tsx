...
import { ArrowLeft, Clock, Users, ChefHat, Utensils, Star, Heart, Share2 } from "lucide-react"
        ...
        return (
            <main className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
                ...
                <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-10 max-w-md w-full border border-white/50 text-center">
                    ...
                    <p className="text-red-600 mb-6">Error loading recipe: {fetchError}</p>
                    <Link
                        href="/recipes"
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50">
                        <div className="relative">
                                    ...
                                    {recipe.spoonacularScore && (
                                        <div className="absolute bottom-8 right-4 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg">
                                            <div className="flex items-center text-sm font-semibold">
                                                ...
                                                <span className="text-gray-800">{Math.round(recipe.spoonacularScore)}/100</span>
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 md:p-8">
                                <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">{recipe.title}</h1>
                        ...
                        <div className="p-6 md:p-8 space-y-8">
                              ...
                              {ing.original ||
                                  ...
                                  `${ing.amount || ""} ${ing.unit || ""} ${ing.name || ""}`}
                                            ...
                                            <div className="flex flex-col items-center justify-center py-8 text-center">
                                                ...
                                                <h3 className="text-lg font-medium text-gray-800 mb-2">No Ingredients Listed</h3>
                                                <p className="text-gray-600 max-w-xs">
                                                    This recipe doesn't have a detailed ingredients list. You might find ingredient information in
                                    ...
                                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/50">
                                        {recipe.instructions ? (
                                            ...
                                            <div className="flex flex-col items-center justify-center py-8 text-center">
                                                ...
                                                <h3 className="text-lg font-medium text-gray-800 mb-2">No Instructions Available</h3>
                                                <p className="text-gray-600 max-w-xs">
                                                    This recipe doesn't include cooking instructions. You might want to try another recipe.
                                                </p>
                                            </div>
                                        )}
                                    </div>
                            ...
                            {recipe.nutrition && recipe.nutrition.nutrients && recipe.nutrition.nutrients.length > 0 && (
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100">
                                    <h3 className="text-lg font-bold text-gray-800 mb-4">Nutrition Information</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {recipe.nutrition.nutrients.slice(0, 4).map((nutrient: any) => (
                                            <div key={nutrient.name} className="text-center">
                                                <div className="text-2xl font-bold text-green-600">{Math.round(nutrient.amount)}</div>
