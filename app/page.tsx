...
export default function SearchPage() {
  ...
  const isFormValid = query.trim() !== "" || cuisine.trim() !== "" || maxReadyTime.trim() !== ""
      ...
      <main className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-10 max-w-lg w-full border border-white/50 hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">Discover delicious meals tailored to your taste</p>
            <div className="h-1 w-20 mx-auto bg-gradient-to-r from-orange-400 to-amber-400 rounded-full mt-4"></div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              <label htmlFor="query" className="flex items-center text-sm font-semibold text-gray-700 mb-3">
            ...
            <div className="group">
              <label htmlFor="cuisine" className="flex items-center text-sm font-semibold text-gray-700 mb-3">
            ...
            {/* Max Prep Time Field */}
            <div className="group">
              <label htmlFor="maxReadyTime" className="flex items-center text-sm font-semibold text-gray-700 mb-3">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200/50">
            <p className="text-xs text-gray-500 text-center mb-3">Popular searches</p>
            <div className="flex flex-wrap gap-2 justify-center">
              {["Pasta", "Chicken", "Vegetarian", "Quick meals"].map((suggestion) => (
                  <button
                      key={suggestion}
